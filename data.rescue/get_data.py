...
base_date=datetime.datetime.strptime("1872-11-22:12:00:00",
                                     "%Y-%m-%d:%H:%M:%S")
...
for i in range(1,5):
    for j in range(1,6):
        ...
        print(t_date.year)
        #try:
           #retrieve_for_year(t_date.year,'3.5.1',source='scratch')
        #except:
           #print "Failed 3.5.1 retrieval for %d" % t_date.year
        count=count+1

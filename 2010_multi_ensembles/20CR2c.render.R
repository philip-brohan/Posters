...
draw.streamlines<-function(s,Options) {
    ...
    u<-TWCR.get.member.at.hour('uwnd.10m',opt$year,opt$month,opt$day,opt$hour,member=opt$member,version='3.5.1')
    v<-TWCR.get.member.at.hour('vwnd.10m',opt$year,opt$month,opt$day,opt$hour,member=opt$member,version='3.5.1')
...
image.name<-sprintf("20CR2c_%02d.png",opt$member)
...
png(ifile.name,
  ...
  t2m<-TWCR.get.member.at.hour('air.2m',opt$year,opt$month,opt$day,opt$hour,
                               member=opt$member,version='3.5.1')
  ...
  mslp<-TWCR.get.member.at.hour('prmsl',opt$year,opt$month,opt$day,opt$hour,
                                member=opt$member,version='3.5.1')
  ...
  prate<-TWCR.get.member.at.hour('prate',opt$year,opt$month,opt$day,opt$hour,
                                 member=opt$member,version='3.5.1')

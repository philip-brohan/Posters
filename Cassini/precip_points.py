...
for p_i in range(len(p_points['Longitude'])):
    ...
    circle = CirclePolygon((p_points['Longitude'][p_i], 
                            p_points['Latitude'][p_i]), 
                            radius=max(0,0.25*min(1,p_at/pmax)),
                            edgecolor=(0,0.3,0,shade),
                            facecolor=(0,0.3,0,shade),
                            linewidth=0,
                            fill=True,
                            zorder=500)

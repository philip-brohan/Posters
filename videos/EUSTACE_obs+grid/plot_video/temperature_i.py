...
analysis_m += EUSTACE_average_for_day(pday.year,pday.month,pday.day)
analysis_m /= 2
...
pday = target+datetime.timedelta(days=1)
analysis_o += EUSTACE_obs_influence_for_day(pday.year,pday.month,pday.day)
analysis_o /= 2
...
fig.savefig('%s/%04d%02d%02d12.png' % (args.opdir,args.year,
                                     args.month,args.day))

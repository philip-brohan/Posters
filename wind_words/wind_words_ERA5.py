...
uwnd = iris.util.squeeze(
    iris.load_cube("./Wind_2024120706_no_expver.nc", "10 metre U wind component")
)
uwnd.coord("latitude").coord_system = cs_ERA5
uwnd.coord("longitude").coord_system = cs_ERA5
vwnd = iris.util.squeeze(
    iris.load_cube("./Wind_2024120706_no_expver.nc", "10 metre V wind component")
)
vwnd.coord("latitude").coord_system = cs_ERA5
vwnd.coord("longitude").coord_system = cs_ERA5
land_mask = iris.util.squeeze(
    iris.load_cube("./Wind_2024120706_no_expver.nc", "Land-sea mask")
)
land_mask.coord("latitude").coord_system = cs_ERA5
land_mask.coord("longitude").coord_system = cs_ERA5

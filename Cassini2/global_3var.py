...
# In the modified Cassini projection
...
sys.path.append('%s/../../ML_GCM/lib/' % os.path.dirname(__file__))
...
parser.add_argument("--pole_longitude", help="Longitude of projection pole",
                    default=60,type=float,required=False)
parser.add_argument("--npg_longitude", help="Longitude of view centre",
                    default=270,type=float,required=False)

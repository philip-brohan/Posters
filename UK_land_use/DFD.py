...
# This version matches the dataset grid resolution to the final pixel resolution 
...
def plot_cube(
    ...
    lat_values = np.linspace(ymin, ymax,10800)
    latitude = iris.coords.DimCoord(
        lat_values, standard_name="latitude", units="degrees_north", coord_system=cs
    )
    lon_values = np.linspace(xmin, xmax, 7200)
